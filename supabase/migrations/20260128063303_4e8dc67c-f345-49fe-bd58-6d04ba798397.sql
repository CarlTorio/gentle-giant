...
CREATE POLICY "Allow select for anon" ON public.members FOR SELECT TO anon USING (true);
CREATE POLICY "Allow insert for anon" ON public.members FOR INSERT TO anon WITH CHECK (true);
CREATE POLICY "Allow update for anon on members" ON public.members FOR UPDATE TO anon USING (true) WITH CHECK (true);
CREATE POLICY "Allow delete for anon on members" ON public.members FOR DELETE TO anon USING (true);
CREATE POLICY "Allow all for authenticated" ON public.members FOR ALL TO authenticated USING (true) WITH CHECK (true);
...
CREATE POLICY "Allow select for anon" ON public.bookings FOR SELECT TO anon USING (true);
CREATE POLICY "Allow insert for anon" ON public.bookings FOR INSERT TO anon WITH CHECK (true);
CREATE POLICY "Allow update for anon on bookings" ON public.bookings FOR UPDATE TO anon USING (true) WITH CHECK (true);
CREATE POLICY "Allow delete for anon on bookings" ON public.bookings FOR DELETE TO anon USING (true);
CREATE POLICY "Allow all for authenticated" ON public.bookings FOR ALL TO authenticated USING (true) WITH CHECK (true);
...
CREATE POLICY "Allow select for anon" ON public.patient_records FOR SELECT TO anon USING (true);
CREATE POLICY "Allow insert for anon" ON public.patient_records FOR INSERT TO anon WITH CHECK (true);
CREATE POLICY "Allow update for anon on patient_records" ON public.patient_records FOR UPDATE TO anon USING (true) WITH CHECK (true);
CREATE POLICY "Allow delete for anon on patient_records" ON public.patient_records FOR DELETE TO anon USING (true);
CREATE POLICY "Allow all for authenticated" ON public.patient_records FOR ALL TO authenticated USING (true) WITH CHECK (true);
...
-- Add FK from bookings to patient_records
...
CREATE POLICY "Allow select for anon" ON public.transactions FOR SELECT TO anon USING (true);
CREATE POLICY "Allow all for authenticated" ON public.transactions FOR ALL TO authenticated USING (true) WITH CHECK (true);
...
CREATE POLICY "Allow select for anon on admin_settings" ON public.admin_settings FOR SELECT USING (true);
CREATE POLICY "Allow all for authenticated on admin_settings" ON public.admin_settings FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow update for anon on admin_settings" ON public.admin_settings FOR UPDATE USING (true) WITH CHECK (true);
CREATE POLICY "Allow insert for anon on admin_settings" ON public.admin_settings FOR INSERT WITH CHECK (true);
...
-- ===========================================================================
-- FUNCTION: Sync member to patient record
-- ===========================================================================
