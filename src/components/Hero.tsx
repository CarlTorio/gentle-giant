...
const Hero = () => {
  return <section className="relative min-h-[80vh] md:min-h-screen flex items-center overflow-hidden pt-8 md:pt-0">
      ...
      ease: "easeOut"
        ...
        <img src="https://i.imgur.com/Ehl3eHG.png" alt="Beautiful women with radiant skin" className="w-full h-full object-cover object-[center_10%]" />
      </motion.div>
